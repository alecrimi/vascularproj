...
known_file_sizes <- c(3.906, 0.516, 0.523, 1.297, 1.82, 2.078, 2.602, 3.383, 3.641, 3.516, 2.336)
...
DoTerastitch <- function(parent_directory, folder_name, pixel_size = 3.26, z_step_size = 3, allow_sparse_data = FALSE) {
  ...
  for (i in seq_along(commands_vec)) {
    ...
    assign("delete_command_splits", command_splits, envir = globalenv())
    assign("delete_TeraStitcherToConsole", TeraStitcherToConsole, envir = globalenv())
    assign("delete_stderr_function", function(line, process) cat(line), envir = globalenv())
    assign("delete_parent_directory", parent_directory, envir = globalenv())
    assign("delete_args", args, envir = globalenv())
...
# ### Perform stitching ###
# 
# RunStitch(raw_files_root_path = raw_files_folder, split_and_stitch_root_path = split_and_stitch_folder, emission_filters = "565",
#           skip_already_present_splits = TRUE, skip_already_present_stitches = TRUE, check_metadata = FALSE, allow_sparse_data = FALSE
#           )
# RunStitch(raw_files_root_path = raw_files_folder, split_and_stitch_root_path = split_and_stitch_folder, emission_filters = "498",
#           skip_already_present_splits = TRUE, skip_already_present_stitches = TRUE, check_metadata = FALSE, allow_sparse_data = FALSE
#           )
# 
# 
...
layout_mat_AMR_2x <- matrix(1:4, ncol = 2)
# layout_mat_AMR_4x <- cbind(1:4, rev(5:8), 9:12)
layout_mat_AMR_4x <- matrix(1:36, ncol = 6)
...
# CheckAllForCompleteness(raw_files_folder, split_and_stitch_folder, raise_metadata_error = FALSE, raise_error = FALSE, emission_filters = "515LP",
#                         use_physical_layout_mat = layout_mat_AMR_4x, no_rotation = TRUE
#                         )
...
RunStitch(raw_files_root_path = raw_files_folder, split_and_stitch_root_path = split_and_stitch_folder, emission_filters = c("520SG", "562SG"),
          skip_already_present_splits = TRUE, skip_already_present_stitches = TRUE, check_metadata = FALSE, allow_sparse_data = FALSE,
          no_rotation = TRUE, use_physical_layout_mat = layout_mat_AMR_2x, displacement_in_microns = 5500
          )

RunStitch(raw_files_root_path = raw_files_folder, split_and_stitch_root_path = split_and_stitch_folder, emission_filters = c("520SG", "647SG"),
          skip_already_present_splits = TRUE, skip_already_present_stitches = TRUE, check_metadata = FALSE, allow_sparse_data = FALSE,
          no_rotation = TRUE, use_physical_layout_mat = layout_mat_AMR_4x, displacement_in_microns = 2500L
          )

RunStitch(raw_files_root_path = raw_files_folder, split_and_stitch_root_path = split_and_stitch_folder, emission_filters = c("520SG"),
          skip_already_present_splits = TRUE, skip_already_present_stitches = TRUE, check_metadata = FALSE, allow_sparse_data = FALSE,
          no_rotation = TRUE, use_physical_layout_mat = layout_mat_AMR_4x, displacement_in_microns = 2500L
          )
